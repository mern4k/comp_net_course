...
#### Демонстрация работы
Я реализовал все кроме дуплексной передачи. Помимо имитации потери покетов я добавил симуляцию искажения битов для наглядности работы контрольных сумм. По итогу я решил отправить картинку Лены, в общем вот логи:
