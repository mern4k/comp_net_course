...
def send_mail(mail_socket, to_addr : str, format: str, body: str):
    if format == "txt":
...
if __name__ == "__main__":
    ...
    send_mail(mail_socket=mail_socket, to_addr="recipient@example.com", format="txt", body="Hello, this is a test email in txt using socket!")
    time.sleep(10)
    send_mail(mail_socket=mail_socket, to_addr="recipient@example.com", format="html", body="Hello, this is a test email in html format using socket!")
