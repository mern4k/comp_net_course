...
#### Решение
Задержка передачи равна $\frac{1}{100} \cdot 10^3 = 10$ миллисекунд, значит средняя общая задержка равна 20 миллисекундам. По формуле Литтла $a = \frac{N}{d} = \frac{10}{10 + 10} = 0.5$ пакетов в миллисекунду, то есть 500 пакетов в секунду.
